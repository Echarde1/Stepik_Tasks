...
public class Foo {
  ...
  public static void main(String[] args) throws IOException {
    final Foo main = new Foo();

    final int MODULUS = 1_000_000_001;
    long sum_prev = 0;
    List<String> tmpAnswers = new LinkedList<>();
    //BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
    BufferedReader reader = new BufferedReader(new FileReader("/home/danil/Documents/Java_Projects/Stepik_Projects/Algorithms_Chapter_Two/Search_Trees/BinarySearchTree/src/main/java/input.txt"));
    ...
    //main.root.print();
    tmpAnswers.forEach(System.out::println);
  }
}